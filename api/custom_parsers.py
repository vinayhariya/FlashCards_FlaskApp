...
card_updation_parser.add_argument("user_id")
card_updation_parser.add_argument("api_key")
card_updation_parser.add_argument("deck_id")
card_updation_parser.add_argument("card_id")
card_updation_parser.add_argument("front")
card_updation_parser.add_argument("back")

solving_deck_parser = reqparse.RequestParser()
solving_deck_parser.add_argument("user_id")
solving_deck_parser.add_argument("api_key")
solving_deck_parser.add_argument("deck_id")
solving_deck_parser.add_argument("card_id")
solving_deck_parser.add_argument("solve_id")
